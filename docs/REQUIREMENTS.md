...
Guardian Core gives you the core functionality without that mess.
...
- Custom `guardian_core` MCP server (inside container) provides scheduling tools
...
**Guardian Core** - A reference to Clawdbot (now OpenClaw).
