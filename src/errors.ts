...
// --- Container errors ---
export class ContainerSpawnError extends Data.TaggedError(
  'ContainerSpawnError',
)<{
...
export class ContainerExitError extends Data.TaggedError(
  'ContainerExitError',
)<{
  readonly group: string;
...
export class MountAllowlistNotFoundError extends Data.TaggedError(
  'MountAllowlistNotFoundError',
)<{
  readonly path: string;
}> {}

export class MountAllowlistParseError extends Data.TaggedError(
...
export class MountValidationError extends Data.TaggedError(
...
// --- WhatsApp errors ---
export class WhatsAppConnectionError extends Data.TaggedError(
...
// --- Phone caller errors ---
export class PhoneCallerConfigError extends Data.TaggedError(
  'PhoneCallerConfigError',
)<{
  readonly message: string;
}> {}

export class PhoneCallerApiError extends Data.TaggedError(
  'PhoneCallerApiError',
)<{
  readonly message: string;
...
export class PhoneContactsNotFoundError extends Data.TaggedError(
  'PhoneContactsNotFoundError',
)<{
  readonly path: string;
}> {}

export class PhoneContactsParseError extends Data.TaggedError(
  'PhoneContactsParseError',
)<{
  readonly path: string;
  readonly message: string;
  readonly cause?: unknown;
...
export class IpcAuthorizationError extends Data.TaggedError(
